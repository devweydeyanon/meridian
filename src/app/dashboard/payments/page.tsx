...
export default function PaymentsPage() {
  const { accounts, payees, loading } = useDashboard();
        ...
        <div className="max-w-[480px] space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4 max-md:grid-cols-1">
            ...
            <div>
              ...
              <input type="date" defaultValue={new Date().toISOString().split('T')[0]} className="w-full px-3.5 py-2.5 text-sm border border-gray-300 rounded-md outline-none focus:border-accent-500" />
            </div>
          </div>
